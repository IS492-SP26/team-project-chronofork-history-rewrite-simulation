...
const zhDict: Record<string, string> = {
  ...
  "Manual backtrack": "手动回溯",
  "Select a node from the Timeline panel, then choose who you want to play.": "请在左侧时间线中手动选择节点，然后选择你要扮演的角色。",
  "Write your alternative decision...": "写下你的替代决策...",
  "Type in character as": "以该角色身份输入：",
  "Tips (Take ~5s)": "建议（约5秒）",
  "Get Strategic Advice": "获取策略建议",
  "Strategic Options": "策略选项",
  "Waiting for response...": "等待回应中...",
  "Send This": "发送此建议",
  ...
  "Intervention": "干预",
  "Send": "发送",
  "Generating Reflection... (Take ~15s)": "正在生成复盘... (约15秒)",
  ...
  "Export Report": "导出报告",
  "Export Save": "导出存档",
  "Download Report HTML": "下载报告 HTML",
  "Report HTML downloaded.": "报告 HTML 已下载。",
  ...
  " is ready to speak.": " 即将发言。",
  "Next": "下一步",
  "Speaking": "说话中",
  "Listening": "正在听",
  "Takeover": "接管",
  "All agents → LLM": "全部角色 → AI 托管",
  "Auto Agent": "自动代理",
  "Hand off all roles to AI. Watch the dialogue unfold automatically — take over any agent at any time.": "将所有角色交由 AI 托管，自动推进对话。你可以随时接管任意角色。",
  "Enable Auto Agent": "开启自动代理",
  "Auto Agent Active": "自动代理运行中",
  "Type Manually": "手动输入",
  "Choose Your Path": "选择你的路径",
  "Play as": "扮演",
  "Node": "节点",
  "Generating Reflection... (Take ~30s)": "正在生成复盘... (约30秒)",
}
