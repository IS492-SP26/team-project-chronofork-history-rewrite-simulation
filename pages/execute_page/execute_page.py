...
class ExecutePage(pn.viewable.Viewer):
    ...
    def __init__(self, **params):
        ...
        confirmed_agents = f"## Agent List for: {self.task_name}\n"
        ...
        agent_card = pn.Card(agent_card_content, sizing_mode='stretch_height',title='Agent List',margin=(0, 10, 0, 0), width=400)


        self.progress_indicator = ProcessIndicator(steps=self.steps)
        process_card = pn.Card(self.progress_indicator, title='Process Indicator', sizing_mode='stretch_height',margin=(10, 10, 0, 0), width=400)
